...
In dit hoofdstuk gaan we de kennis die je hebt opgedaan in de voorgaande lessen toepassen op een nieuwe dataset. We zullen werken met gegevens van TechTrends BV's voorraad- en verkoopbeheer voor het jaar 2024.

## 1.4.1 De Dataset

Download het onderstaande bestand om de oefeningen uit te voeren.

[Download TechTrends_Voorraad_2024.csv](/downloads/bwe/TechTrends_Voorraad_2024.csv)
...
## 1.4.2 Basisformattering en Gegevensorganisatie
...
## 1.4.3 Berekeningen en Functies
...
## 1.4.7 Celverwijzingen en Autofill
